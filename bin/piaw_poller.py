...
purpose:
  ...
  Save in both JSON (raw format received from PiAware) and
               NDJSON (used by Elasticsearch)
"""
import sys
import os
import time
...
WAIT_OFFSET = 3.14159652
URL = 'http://192.168.1.208:8080/data/aircraft.json'
# deprecated 2/21/2022
#BASE_DATA_DIR = '/data/piaware'

#BASE_DATA_DIR = '/data/piaware-test/piaw_raw'
BASE_DATA_DIR = '/data/piaware/piaw_raw'
BASE_FILE_NAME = 'piaware_raw-'

# not used as of 2/21/2022
WRITE_NDJSON = True
BASE_DATA_DIR_NDJSON = '/data/piaware-test/piaw_ndjson'
BASE_FILE_NAME_NDJSON = 'piaware_raw-'
